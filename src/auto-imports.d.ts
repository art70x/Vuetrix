...
declare global {
  ...
  const isDark: typeof import('./lib/utils').isDark
  ...
  const preferredDark: typeof import('./lib/utils').preferredDark
  ...
  const storageKey: typeof import('./lib/utils').storageKey
  ...
  const toggleDark: typeof import('./lib/utils').toggleDark
  ...
  const useDatasets: typeof import('./composables/use-datasets').useDatasets
  ...
  const useMetadata: typeof import('./composables/use-metadata').useMetadata
  ...
  const useSeo: typeof import('./composables/use-seo').useSeo
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly isDark: UnwrapRef<(typeof import('./lib/utils'))['isDark']>
    ...
    readonly preferredDark: UnwrapRef<(typeof import('./lib/utils'))['preferredDark']>
    ...
    readonly toggleDark: UnwrapRef<(typeof import('./lib/utils'))['toggleDark']>
    ...
    readonly useMetadata: UnwrapRef<(typeof import('./composables/use-metadata'))['useMetadata']>
    ...
    readonly useSeo: UnwrapRef<(typeof import('./composables/use-seo'))['useSeo']>
